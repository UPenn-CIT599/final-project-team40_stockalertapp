...
public class ChartData {
    ...
    /**
     * Returns a TreeMap for plotting x axis labels.  The key is the label and the value is the plot point.
     * @return
     */
    ...
    /**
     * Returns a TreeMap for plotting y axis labels.  The key is the label and the value is the plot point.
     * @return
     */
    ...
    /**
     * Returns a TreeMap for plotting price points on the Chart.  The key is the date and the value is an array representing x, y coordinates to plot.
     * @return
     */
