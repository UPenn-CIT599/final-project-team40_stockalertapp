...
class ChartDataTest {
    ...
    private final ChartData chart = new ChartData(gen.getHistorialBars(), 300, 300, 30, 5);
    ...
    void testChangeStock() {
        ...
        TreeMap<LocalDate, OHLCV> testBars = gen2.getHistorialBars();
    ...
    void testXAxisTicksSplits() {
        gen.setTimeLength(9);
        chart.changeStock(gen.getHistorialBars());
